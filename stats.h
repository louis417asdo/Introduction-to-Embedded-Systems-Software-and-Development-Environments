 ...
 * @file <stats.h> 
 *
 * @brief <The stats.h header file needs to include declarations and 
 ...
 * With each declaration you need to provide comments with a description of 
 * the function, the inputs, and return value. An example is provided below 
 * for a function swap32() that does a byte swap of a 32-bit data item.>
 *
